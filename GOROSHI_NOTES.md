...
**Repo name**: `mt5-liquidity-sweep-ind`
...
```
MT5 liquidity-sweep indicator.
```

## How GOROSHI uses it

`The sweep entry mechanism tested (PF 0.86 raw, 1.79 filtered but 31.6% stability).`
...
`Research reference for EA_Template.` -- e.g. "called from `goroshi-swarm/bin/worker.py`
